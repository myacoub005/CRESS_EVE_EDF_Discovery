#!/bin/bash
#SBATCH -p epyc -N 1 -n 16 --mem 64gb --out logs/Kaz_Tree_trimmed.3.log
...
INDIR=REP_Phylo
OUTDIR=$INDIR/rtREV+G+F/Trimmed/Gappyout
...
iqtree2 -T AUTO -s Fungi_REP.rmdup.tree.aa.gappyout.rename.aln -B 10000 -m MFP
