#!/bin/bash
#SBATCH -p epyc -N 1 -n 16 --mem 64gb --out logs/Kaz_Tree.constrain.log
...
INDIR=REP_Phylo
OUTDIR=$INDIR/Phylogeny_Constraint
...
iqtree2 -T AUTO -s Fungi_REP.rmdup.tree.rename.1.aa.aln -alrt 1000 -m MFP -g CRESS.aa.nwk.tree
