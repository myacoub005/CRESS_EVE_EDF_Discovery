#!/bin/bash
#SBATCH -p epyc -N 1 -n 16 --mem 64gb --out logs/Kaz_Tree.gappout.VTR10.4.log
...
INDIR=REP_Phylo
OUTDIR=$INDIR/rtREV+G+F/Trimmed/Gappyout/VT+R10
...
iqtree2 -T AUTO -s Fungi_REP.rmdup.tree.aa.gappyout.rename.aln -B 10000 -m VT+R10
