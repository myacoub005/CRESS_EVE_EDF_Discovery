#!/bin/bash
#SBATCH -p batch -N 1 -n 16 --mem 64gb --out logs/Kaz_Tree_trimmed.2.log
...
INDIR=REP_Phylo
OUTDIR=$INDIR/rtREV+G+F/Trimmed/Raxml
...
#trimal -gappyout -in $INDIR/Fungi_REP.rmdup.tree.aa.aln -out $OUTDIR/Fungi_REP.rmdup.tree.aa.gappyout.aln
